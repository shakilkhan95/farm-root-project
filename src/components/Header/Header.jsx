    ...
    return (
        <header className='flex justify-between items-center p-5 md:px-10 lg:px-10 bg-[#C4DBCE]'>
            ...
            <nav className='flex gap-6'>
                ...
                <a href="/" className='navHover'>Contact Us</a>
                
            {/* icons section  */}
            <div className='flex gap-2 ml-8'>
                <span className='icons hover:bg-green-500 hover:text-white cursor-pointer'><FiSearch/></span>
                <span className='icons hover:bg-green-500 hover:text-white cursor-pointer'><IoIosContact/></span>
                <span className='icons hover:bg-green-500 hover:text-white cursor-pointer'><FiShoppingCart/></span>
            </div>
            </nav>
